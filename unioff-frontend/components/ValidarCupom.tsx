    ...
    <form onSubmit={aoEnviar} className="flex max-w-lg flex-col gap-4">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="min-w-0 flex-1 rounded border-2 border-borda bg-fundo-duro px-4 py-3 font-mono text-2xl font-bold uppercase tracking-widest focus:border-amarelo focus:outline-none"
        />
