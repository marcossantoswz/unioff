...
export default function EmpresaPage() {
  ...
  if (!empresa) return <p className="text-apagado">Carregando estabelecimento…</p>;
  ...
  return (
    <>
      <header className="grid gap-8 border-b border-linha pb-8 md:grid-cols-[1fr_18rem]">
        <div>
        ...
        <dl className="flex flex-col gap-3 text-sm">
          {endereco && (
            <div>
              ...
              <dd className="font-semibold">{endereco}</dd>
            </div>
          )}
          {whatsapp && (
            <div>
              ...
              <dd>
                <a href={whatsapp} target="_blank" rel="noreferrer" className="font-semibold text-carimbo hover:underline">
          ...
          {empresa.site && (
            <div>
              ...
              <dd>
                <a href={linkSite(empresa.site)} target="_blank" rel="noreferrer" className="font-semibold text-carimbo hover:underline">
                  {empresa.site}
                </a>
              </dd>
            </div>
