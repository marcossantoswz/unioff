...
export default function CadastroPage() {
  ...
  return (
    <section className="mx-auto max-w-lg">
      ...
      <div role="tablist" aria-label="Tipo de conta" className="mt-6 grid grid-cols-2 rounded border border-borda bg-fundo-duro p-1">
        {(["estudante", "empresa"] as const).map((opcao) => (
          <button
            ...
            className="rounded py-2 font-semibold text-apagado aria-selected:bg-amarelo aria-selected:text-sobre-destaque"
          >
      ...
      <p className="mt-6 text-sm text-apagado">
        Já tem conta?{" "}
        <Link href="/login" className="font-semibold text-aqua hover:underline">
          Entrar
        </Link>
      </p>
    </section>
